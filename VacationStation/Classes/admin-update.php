...
if($_SESSION["is_admin"] !== true || !isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
...
<body>
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12" id="updateRecord">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <a href="admin-userlist.php" class="btn btn-default">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
